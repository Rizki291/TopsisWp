...
<div id="page-wrapper">
    <div class="main-page">
        <div class="tables">
            <h2 class="title1">Tabel Data Pelatih</h2>
            <div class="panel-body widget-shadow">
                    ...
                    <tbody>
                        ...
                        while ($data = mysqli_fetch_array($result)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="ubah_data_pelatih.php?kode=<?php echo $data ['id_pelatih']; ?>" >
                                        <button class="btn btn-primary btn-flat "><i class="fa fa-edit" aria-hidden="true"></i></button>
                                         <a href="../crud/hapus_pelatih.php?id= <?php echo $data['id_pelatih'] ?>" onclick="return confirm('Anda Yakin Menghapus Data ini ?')">
                                        <button type="button" class="btn btn-warning btn-flat "><i class="fa fa-trash-o" aria-hidden="true"></i></button>
                                </td> 
                            </tr> 
                        <?php } ?>
                    </tbody> 
                ...
                <div>
                    ...
                    <a href="form_tambah_pelatih.php" type="button" class="btn btn-success">Tambah Data</a>
                </div>
            </div>
        </div>
    </div>
