...
<html>
    ...
    <div id="page-wrapper">
        <div class="main-page">
            <div class="tables">
                <h2 class="title1">Tabel Data Peserta</h2>
                        ...
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_array($result)) {
                                ...
                                <tr> 
                                    ...
                                    <td> 
                                        <a href="ubah_data_peserta.php?kode=<?php echo $data ['nisn']; ?>" ><button class="btn btn-primary btn-flat "><i class="fa fa-edit" aria-hidden="true"></i></button>
                                            <a href="../crud/hapus_peserta.php?id= <?php echo $data['id'] ?>" onclick="return confirm('Anda Yakin Menghapus Data ini ?')">
                                            ...
                                            <div>
                                                ...
                                                <a href="form_tambah_peserta.php" type="button" class="btn btn-success">Tambah Data</a>
                                            </div>
                                            </div>
                                            </div>
                                            </div>
