                ...
                <div class="main-page">
                    <div class="forms">
                        ...
                        <div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
                            ...
                            <div class="form-body">
                                <form action="../crud/tambah_kriteria.php" method="post" role="form">

                                    <div class="form-group"> 
                                        <label for="">Nama Kriteria :</label> 
                                        <input type="" class="form-control" id="nama_Kriteria" name="nama_kriteria" placeholder="" required="">
                                    </div> 

                                    <div class="form-group">
                                        <label for="">Tipe Kriteria:</label>
                                        <select class="form-control1" id="tipe_kriteria"name="tipe_kriteria" >
                                    ...
                                    <div class="form-group"> 
                                        ...
                                        <input type="" class="form-control" id="bobot" name="bobot" placeholder="" required="">
                                    </div>
                                    <div class="form-group">
