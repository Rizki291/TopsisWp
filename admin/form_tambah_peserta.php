                ...
                <div class="main-page">
                    <div class="forms">
                        ...
                        <div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
                            ...
                            <div class="form-body">
                                <form action="../crud/tambah_peserta.php" method="post" role="form">
                                    <div class="form-group"> <label for="">NISN :</label> 
                                        <input type="" class="form-control" id="nisn" name="nisn" placeholder="">
                                    </div>
                                    <div class="form-group"> <label for="">Nama :</label> 
                                        <input type="" class="form-control" id="nama_peserta" name="nama_peserta" placeholder="">
                                    </div>
                                    <div class="form-group"> <label for="">Tempat Tanggal Lahir:</label>
                                        <input type="" class="form-control" id="ttl" name="ttl" placeholder="">
                                    </div>
                                    <div class="form-group"> <label for="">Alamat:</label>
                                        <input type="" class="form-control" id="alamat" name="alamat" placeholder="">
                                    </div> 
                                    <div class="form-group"> <label for="">Asal Sekolah:</label> 
                                        <input type="" class="form-control" id="asal_sekolah" name="asal_sekolah" placeholder="">
                                    </div> 
