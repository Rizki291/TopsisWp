...
$query = "select * from tbl_kriteria order by nama_kriteria asc";
...
<html>
    ...
    <div id="page-wrapper">
        <div class="main-page">
            <div class="tables">
                <h2 class="title1">Tabel Data Kriteria</h2>
                        ...
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_array($result)) {
                                ...
                                <tr> 
                                    ...
                                    <td>
                                        <a href="ubah_data_kriteria.php?kode=<?php echo $data ['id_kriteria']; ?>" >
                                            <button type="button" class="btn btn-primary btn-flat "><i class="fa fa-edit" aria-hidden="true"></i></button>
                                            <a href="../crud/hapus_kriteria.php?id= <?php echo $data['id_kriteria'] ?>" onclick="return confirm('Anda Yakin Menghapus Data ini ?')">
                                                <button type="button" class="btn btn-warning btn-flat "><i class="fa fa-trash-o" aria-hidden="true"></i></button></td>
                                                </tr> 
                                            <?php } ?>
                                            </tbody> 
                                            </table> 
                                            <div>
                                                <!-- Standard button -->
                                                <a href="form_tambah_kriteria.php" type="button" class="btn btn-success">Tambah Data</a>
                                            </div>
                                            </div>
                                            </div>
                                            </div>
