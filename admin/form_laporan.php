...
<html>
    ...
    <body class="cbp-spmenu-push">
        ...
        <div id="page-wrapper">
            <div class="main-page">
                <div class="tables">
                    <h2 class="title1">Form Laporan</h2>
                    <div class="panel-body widget-shadow">
                        <h4>TABLE WP</h4>
                        <table class="table table-bordered"> 
                            <thead>
                                <th>ID</th><th>Nama</th><th>HASIL</th><th>PERINGKAT</th>
                            </thead>
                            <tbody>
                            <?php
                                ...
                                while ($data = mysqli_fetch_array($querywp)) {
                                    ...
                                    $query2 =mysqli_query($koneksi,"select * from tbl_peserta where nisn=".$data['id_alternatif']);
                                    $exec = mysqli_fetch_array($query2);
                                    echo "<td>$exec[nama_peserta]</td>";
                        ...
                        <a href="export.php" type="button" class="btn btn-success">Export</a>
                    </div>
