                    ...
                    <div class="forms">
                        ...
                        <div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
                            <div class="form-title">
                                <h4>Tambah Data Pelatih</h4>
                            </div>
                            <div class="form-body">
                                <form action="../crud/tambah_pelatih.php" method="post" role="form">
                                    <div class="form-group"> 
                                        <label for="">Nama Pelatih :</label> 
                                        <input type="" class="form-control" id="nama_pelatih" name="nama_pelatih" placeholder="" required="">
                                    </div> 
                                    <div class="form-group"> 
                                        <label for="">Instansi:</label> 
                                        <input type="" class="form-control" id="instansi" name="instansi"placeholder="" required="">
                                    </div> 
                                    <div class="form-group"> 
                                        <label for="">Kedudukan:</label> 
                                        <input type="" class="form-control" id="kedudukan" name="kedudukan" placeholder="" required="">
                                    </div> 
