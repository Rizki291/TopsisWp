                ...
                <div class="main-page">
                    <div class="forms">
                        ...
                        <div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
                            ...
                            <div class="form-body">
                                <form action="../crud/tambah_admin.php" method="post" role="form">
                                    <div class="form-group"> 
                                        <label for="">Nama Lengkap :</label> 
                                        <input type="" class="form-control" id="nama_lengkap" name="nama_lengkap" placeholder="Nama Lenkap" required="">
                                    </div> 
                                    <div class="form-group"> 
                                        <label for="">Username :</label> 
                                        <input type="" class="form-control" id="username" name="username" placeholder="Username" required="">
                                    </div> 
                                    <div class="form-group"> 
